...
class CosmicAtlasApp(ctk.CTk):
	def __init__(self):
		...
		#Applying bg image
		bg_img=Image.open("images/galaxy.png")
	...
	def setup_home_page(self):
		#title
		ctk.CTkLabel(self.home_frame, text="COSMIC ATLAS", font=("Times New Roman", 50, "bold"), text_color="white").pack(pady=(20,5))
		...
		#solar system image
		solar_img=Image.open("images/solar.jpg")
	...
	def show_planet_page(self):
		...
		#photo
		raw_img=Image.open(f"images/{selected}.jpg")
		...
		ctk.CTkLabel(content_frame, text=stats_text, wraplength=400, font=("Arial", 16), justify="left").grid(row=0, column=1, sticky="nw", padx=20 )
		#try again feature
